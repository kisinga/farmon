...
// Error object per DATA_CONTRACT §5: ec, na, jf, sf with standard labels
...
export default {
    setup() {
        ...
        /** Error object values for display (DATA_CONTRACT §5). Keys: ec, na, jf, sf */
        ...
        const topBarExcludeKeys = ['tsr', ...ERROR_OBJECT_KEYS];
        return {
            deviceMeta,
            currentData,
            topBarFields,
    ...
    template: `
        <div v-if="hasTopBarStats" class="flex flex-wrap items-center justify-center gap-2 py-1">
            ...
            <div v-if="f && !topBarExcludeKeys.includes(f.key)" class="badge badge-ghost text-xs">
