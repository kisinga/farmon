/** Board definition types — mirrors lib/board.ts schema. */
...
/** Compute reserved pins from a board definition. */
...
/** Pin assignment color categories. */
export const PIN_COLORS = {
  tank: '#14b8a6',       // teal-500
  valve: '#e11d48',      // rose-600
  flow: '#16a34a',       // green-600
  pump: '#dc2626',       // red-600
