/** Marketing design-system primitives. Import from here, e.g.
 *  `import { MktSection, MktCardComponent } from '../../shared/marketing/ui';` */
export { MktSectionComponent } from './mkt-section.component';
export { MktHeroComponent } from './mkt-hero.component';
