...
import { ManifestSchema, type Manifest } from "../lib/schema.js";
...
const MANIFEST_PATH = path.join(ROOT, "library/pump-controller.yaml");
const BOARD_DIR = path.join(ROOT, "boards/heltec-v3");
